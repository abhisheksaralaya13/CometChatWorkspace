        ...
        if let user = forUser {
            ...
            if allowBlockUnblockUser {
                ...
                if forUser?.blockedByMe == true {
                    let unblockUserAction = ActionItem(id: "unblock-user", text: "UNBLOCK_USER".localize(), startIcon: nil, endIcon: nil, startIconTint: nil, endIconTint: nil, textColor: CometChatTheme.palatte?.success, textFont: CometChatTheme.typography?.Name2)
