...
//        case .text:  hovers = messageOptions["text"] ?? []
//        case .image: hovers = messageOptions["image"] ?? []
//        case .video: hovers = messageOptions["video"] ?? []
//        case .audio: hovers = messageOptions["audio"] ?? []
//        case .file: hovers = messageOptions["file"] ?? []
