...
@objc @IBDesignable class CometChatMessageList: UIView , NibLoadable {
    ...
    var messageOptions:[String: [MessageOption]] = [String: [MessageOption]]()
    ...
    @objc public func setMessageFilter(templates: [CometChatMessageTemplate]?) -> CometChatMessageList {
        if let messageTemplates = templates {
            ...
            for template in messageTemplates {
                ...
                self.messageCategories = ["message", "custom", "call"]
                self.messageTypes = ["text", "image", "video", "audio", "file", "groupMember", "audio", "video", "location", "extension_poll", "extension_whiteboard", "extension_document", "extension_sticker", "meeting"]
