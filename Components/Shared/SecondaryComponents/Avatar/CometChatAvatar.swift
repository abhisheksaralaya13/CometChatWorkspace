...
@objc public class CometChatAvatar: UIImageView {
    ...
    @objc func setAvatar(user: User) -> CometChatAvatar {
        ...
        let imageView  = UIImageView(frame: strongSelf.frame)
            imageView.setImage(string: user.name?.uppercased(), color: strongSelf.setBackgroundColor, textAttributes: [ NSAttributedString.Key.font: strongSelf.setFont, NSAttributedString.Key.foregroundColor: strongSelf.setFontColor])
            strongSelf.cf.setImage(with: url, placeholder: imageView.image)
            strongSelf.set(outerView: strongSelf.setOuterView)
        }
        return self
    ...
    @objc func setAvatar(group: Group) -> CometChatAvatar {
        ...
        let imageView  = UIImageView(frame: strongSelf.frame)
            imageView.setImage(string: group.name?.uppercased(), color: strongSelf.setBackgroundColor, textAttributes: [ NSAttributedString.Key.font: strongSelf.setFont, NSAttributedString.Key.foregroundColor: strongSelf.setFontColor])
            strongSelf.cf.setImage(with: url, placeholder: imageView.image)
            strongSelf.set(outerView: strongSelf.setOuterView)
        }
        return self
